<template>
    <div class="category-details padding-wrapper">
        <div v-if="category && subtopic">
            ...
            <div>
                <div class="toggle" @click="toggleState" @mouseenter="showText" @mouseleave="hideText">
                    <i class="mdi mdi-ruler" :class="{ active: isActive }"></i>
                    <span v-if="showTooltip" class="tooltip">{{ subtopic.estandar_p }}</span>
                </div>
            </div>

            <v-progress-linear class="margin" :color="category.color" height="10" :model-value="subtopic.pob_value"
            ...
            <v-layout class="rounded rounded-md">
                ...
                <v-main class="d-flex align-center" style="min-height: 500px;">
                    <v-sheet elevation="12" max-width="600" rounded="lg" width="100%" class="pa-4 text-center mx-auto">
                        <v-icon class="mb-5" icon="mdi-toy-brick" size="112" />
